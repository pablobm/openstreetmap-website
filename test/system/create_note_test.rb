...
class CreateNoteTest < ApplicationSystemTestCase
  ...
  js_test "encouragement to contribute appears after 10 created notes and disappears after login" do
  ...
  js_test "encouragement to contribute appears after 10 created notes and disappears after email signup" do
    check_encouragement_while_creating_notes(10)
  ...
  js_test "encouragement to contribute appears after 10 created notes and disappears after google signup" do
    check_encouragement_while_creating_notes(10)
