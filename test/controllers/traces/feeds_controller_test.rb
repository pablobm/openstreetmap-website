...
module Traces
  class FeedsControllerTest < ActionDispatch::IntegrationTest
    ...
    def test_show
      ...
      create(:trace, :without_validations, :visibility => "private", :user => user, :timestamp => 1.second.ago) do |trace|
        create(:tracetag, :trace => trace, :tag => "Birmingham")
      end
    ...
    def test_show_user
      ...
      trace_c = create(:trace, :without_validations, :visibility => "public", :timestamp => 3.seconds.ago, :user => user) do |trace|
        create(:tracetag, :trace => trace, :tag => "London")
      end
